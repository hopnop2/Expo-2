      ...
      <ScrollView>
        <View className="p-4">
          ...
          <View className="items-center mb-6 mt-5">
            <Image
              source={{ uri: 'https://scontent.fbkk22-6.fna.fbcdn.net/v/t39.30808-1/461593325_122146371638280765_311204705144745402_n.jpg?stp=c5.10.940.940a_dst-jpg_s200x200_tt6&_nc_cat=102&ccb=1-7&_nc_sid=e99d92&_nc_eui2=AeFAxNIfXWOX7C2K0nZeWAO0lneoVEH_1oCWd6hUQf_WgACFcish59oDF3ltVi4OfQZER_StumVjBsAqFZ2QLmUx&_nc_ohc=Ch9hyAhQpHMQ7kNvgHpnj34&_nc_oc=AdhxoqNHNOkoCnwFaYRmgURvX85-X7aEDsUFkHyX536ZdGdE0UQGk86yo13RXfxkgVY&_nc_zt=24&_nc_ht=scontent.fbkk22-6.fna&_nc_gid=O-4PZsvWdrz9vEGJzwMMUA&oh=00_AYFxjpCNmxK9b7LQEW-DpeCnzrZRaTcEYMOJH4woFWP_EQ&oe=67DEB6D0' }}
              className="w-20 h-20 rounded-full"
            />
            <Text className="text-3xl mt-5" fontWeight='medium'>Phusin Sosud</Text>
